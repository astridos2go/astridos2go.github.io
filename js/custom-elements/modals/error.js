class ErrorModal extends HTMLElement {
    constructor() {
      ...
      wrapper.setAttribute(
        "class",
        "flex w-fit items-center justify-center gap-1 rounded-lg border-2 border-red-200 bg-red-50 p-2 pointer-events-auto",
      );
      ...
      text.setAttribute("class", "text-sm font-semibold text-red-900");
      ...
      if (this.hasAttribute("clearable")) {
        ...
        clearButtonSVG.setAttribute(
          "class",
          "h-6 w-6 fill-red-400 hover:fill-red-900 hover:bg-red-200/25 ml-4 p-1 rounded-md cursor-pointer",
        );
